      ...
      <View style={styles.header}>
        <View>
          <Text style={styles.title}>
            {t('learning_todos', "Learning To-Do's")}
          </Text>
          <Text style={styles.subtitle}>
            {todos.length}{' '}
            {todos.length === 1
              ? t('question_to_review', 'question to review')
              : t('questions_to_review', 'questions to review')}
          </Text>
        </View>
        {onPractice && (
          <TouchableOpacity
              ...
              <>
                ...
                <View style={styles.modalProgress}>
                  <Text style={styles.modalProgressText}>
                    {t(
                      'progress_info',
                      'Answer correctly {{remaining}} more times to master this question',
                      { remaining: 3 - selectedTodo.correctCount },
                    )}
                  </Text>
                </View>
              </>
